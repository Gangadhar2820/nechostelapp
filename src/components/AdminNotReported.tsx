...
function AdminNotReported() {
  ...
  return (
    <>
      ...
      >
     <Card title="Not Reported Requests">
     <div className="card flex justify-content-center">
            <div className="flex flex-wrap gap-3">
                <div className="flex align-items-center">
                    <RadioButton inputId="not-rep-permissions" name="Permissions" value="Permissions" onChange={(e: RadioButtonChangeEvent) => setSelectionOption(e.value)} checked={selectionOption === 'Permissions'} />
                    <label htmlFor="not-rep-permissions" className="ml-2">Permissions</label>
                </div>
                <div className="flex align-items-center">
                    <RadioButton inputId="not-rep-leaves" name="Leaves" value="Leaves" onChange={(e: RadioButtonChangeEvent) => setSelectionOption(e.value)} checked={selectionOption === 'Leaves'} />
                    <label htmlFor="not-rep-leaves" className="ml-2">Leaves</label>
                </div>
...
export default AdminNotReported;
